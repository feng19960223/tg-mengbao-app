...
import com.turingoal.mengbao.BuildConfig;
...
public class TgApplication extends Application {
    ...
    public static int upgrade; // 火箭,成长值
    public static int flower; // 奖励值

    //各个平台的配置，建议放在全局Application或者程序入口
    {
        PlatformConfig.setAlipay("2018010801687484");
        PlatformConfig.setWeixin("wx967daebe835fbeac", "5bb696d9ccd75a38c8a0bfe0675559b3");
        PlatformConfig.setQQZone("1106655234", "v9RvwIInqj18J2G0");
        PlatformConfig.setSinaWeibo("3627469038", "f2c1e4f60e33f1732b69779f9c4c1b29", "http://sns.whalecloud.com");
    }
    ...
    private static final String APP_KEY = "5a4c75cef29d986b1b00001d";
    private static final String UMENG_MESSAGE_SECRET = "050bd3f767bc2491be29eee232fc86f8";
