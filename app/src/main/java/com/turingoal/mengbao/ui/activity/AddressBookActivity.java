...
import com.turingoal.mengbao.bean.AddressBookSectionBean;
import com.turingoal.mengbao.bean.User;
...
import com.turingoal.mengbao.ui.adapter.AddressBookAdapter;
import com.turingoal.mengbao.ui.adapter.NavAdapter;
...
public class AddressBookActivity extends TgBaseActivity {
    ...
    private List<AddressBookSectionBean> mAddressBookData = new ArrayList<>();
    private AddressBookAdapter mAdapter = new AddressBookAdapter();
    ...
    private void sort(final List<User> users) {
        Collections.sort(users, new Comparator<User>() { // 排序规则
            ...
            public int compare(final User o1, final User o2) {
                CollationKey key1 = Collator.getInstance().getCollationKey(Pinyin.toPinyin(TgStringUtil.getStr(o1.getRealname()), "")); // 名字拼音
                CollationKey key2 = Collator.getInstance().getCollationKey(Pinyin.toPinyin(TgStringUtil.getStr(o2.getRealname()), ""));
