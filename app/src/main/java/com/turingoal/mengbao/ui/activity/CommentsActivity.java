...
import com.turingoal.mengbao.ui.adapter.CommentsAdapter;
 ...
 * 老师点评
 */
@Route(path = ConstantActivityPath.COMMENTS)
public class CommentsActivity extends TgBaseActivity {
    @BindView(R.id.tvTitle)
    TextView tvTitle;
    @BindView(R.id.rvComments)
    RecyclerView rvComments; // 老师点评
    CommentsAdapter mAdapter = new CommentsAdapter(); // adapter
