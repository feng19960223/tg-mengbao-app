...
import com.turingoal.mengbao.ui.fragment.FragmentFactory;
...
public class MainActivity extends TgBaseActivity {
    ...
    protected void initialized() {
        ...
        TgApplication.getTgUserPreferences().setBabyId("c1");
            ...
            public boolean onNavigationItemSelected(@NonNull final MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.navigation_rank:
                        mFragment = FragmentFactory.createFragment(FragmentFactory.FRAGMENT_RANK); // 排行
                        break;
