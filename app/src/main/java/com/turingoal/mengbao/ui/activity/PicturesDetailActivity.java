...
import com.turingoal.mengbao.ui.adapter.PicturesItemAdapter;
import com.turingoal.mengbao.ui.adapter.PicturesViewPagerAdapter;
import com.turingoal.mengbao.ui.fragment.PhotoFragment;
...
public class PicturesDetailActivity extends TgBaseActivity {
    ...
    private AlbumPhoto albumPhoto; // 当前图片
    ...
    private void downloadImg() {
        ...
        GlideApp.with(TgApplication.getContext()).asBitmap().load(albumPhoto.getPhoto()).into(new SimpleTarget<Bitmap>() {
            @Override
