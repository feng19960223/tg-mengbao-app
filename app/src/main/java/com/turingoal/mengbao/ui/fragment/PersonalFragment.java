...
public class PersonalFragment extends TgBaseFragment {
    ...
    public void onResume() {
        ...
        tvName.setText(TgStringUtil.getSelectStr(TgSystemHelper.getRealname(), getString(R.string.default_parents_name)));
    ...
    public void onViewClicked(final View view) {
        switch (view.getId()) {
            case R.id.ivAvatar: // 头像
                TgSystemHelper.handleIntent(ConstantActivityPath.INFO_PARENTS);
                break;
